...
describe('DailyTrackingService', () => {
	...
	describe('getXPGained', () => {
		it('should calculate total XP from all activities', () => {
			const todayData = {
				meals: [{ id: '1', name: 'breakfast', calories: 450 }],
	...
	describe('fetchAndUpdateLocal', () => {
		...
		it('should fetch and update all data from Supabase', async () => {
			const mockMeals = [{ id: 'meal-1', name: 'breakfast', calories: 450 }]
			const mockWorkouts = [{ id: 'w1', calories_burned: 300 }]
			const mockWater = [{ id: 'water-1', glasses: 3 }]
			...
			// Mock the promises for each table
